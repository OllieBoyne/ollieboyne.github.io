...
export const DodoDescription = () => (
    <div>
        ...
        <iframe title="Dodo demo" className="embed-frame" frameborder="0" src="https://itch.io/embed/2320056" width="552" height="167"><a href="https://ollieboyne.itch.io/dodo-demo">Dodo [DEMO] by OllieBoyne</a></iframe>
