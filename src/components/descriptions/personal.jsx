...
export const PersonalDescription = () => (
    <div>
        ...
        <p>My PhD, supervised by <a href="http://mi.eng.cam.ac.uk/~cipolla/index.htm">Prof. Roberto Cipolla</a>, is in <b>accurate foot reconstruction from mobile phone multiview images.</b></p>
        <p style={{"margin-bottom": "40px"}}>I am currently focusing on how <b>synthetic data</b> can help solve this problem.</p>
