...
export const FoundDescription = () => (
  <div>
    ...
    <p className="cite-end"><i>Oliver Boyne, Gwangbin Bae, James Charles, Roberto Cipolla - WACV 2024</i></p>
...
export const FindDescription = () => (
    <div>
      ...
      <p className="cite-end"><i>Oliver Boyne, James Charles, Roberto Cipolla - BMVC 2022</i></p>
